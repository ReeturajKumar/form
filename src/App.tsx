...
export default function App() {
  ...
  const nextStep = () => setStep((prev) => Math.min(prev + 1, STEPS_TOTAL));
            ...
            <div className="relative w-14 h-14 flex items-center justify-center">
              ...
              <svg className="absolute w-full h-full -rotate-90">
                ...
                <motion.circle
                  ...
                  animate={{
                    strokeDashoffset: 163 - 163 * (step / STEPS_TOTAL),
                  }}
            ...
            <AnimatePresence mode="wait">
              {isSubmitted ? (
                ...
                >
                  ...
                  >
                    We've received your plan. Our team will review the details
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <label className="boxed-label">
                        Are You implementing devops tools in your organization?
                      </label>
                      <div className="flex flex-wrap gap-2 mt-2">
                        {DEVOPS_TOOLS.map((value) => {
                          const isSelected =
                            formData.devOpsTools.includes(value);
                          return (
                            <button
                              type="button"
                              key={value}
